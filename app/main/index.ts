...
import { forgeConnectionRequestSchema, generationRequestSchema, IPC, settingsPatchSchema } from "../../packages/contracts/index.ts";
...
function registerIpc():void{
  ...
  handle(IPC.forgeGenerate,async(value)=>await forgeApi.generate(generationRequestSchema.parse(value)));
