...
const root=resolve(import.meta.dirname,"..");const source=resolve(root,"runtime/job-helper/job_owner_helper.rs"),output=resolve(root,"runtime/job-helper/bin/job-owner-helper.exe");await mkdir(resolve(output,".."),{recursive:true});
